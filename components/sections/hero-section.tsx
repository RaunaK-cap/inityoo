  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-15 md:pt-20 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-[-12%] left-[-10%] w-[42%] h-[42%] bg-yellow-300/20 rounded-full blur-[140px]" />
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-3 py-1 rounded-full dark:bg-white/10 border dark:border-white/10   text-sm text-muted-foreground mb-8"
          >
            <span className="relative flex h-2 w-2 [font-family:var(--font-pixel)]">
          ...
          >
            ...
            <TextFlip words={["AI Solutions", "Web Platforms", "Mobile Apps", "Automations"]} className="ml-2 text-2xl md:text-5xl" />
          </motion.h1>
          ...
          >
            Inityo is a full-stack digital agency delivering AI-powered, automated, and scalable solutions tailored for
            the US market. Stop configuring, start innovating.
          </motion.p>
          ...
          >
            ...
            {/* <button className="inline-flex h-12 items-center justify-center rounded-full border border-white/10 bg-white/5 px-8 font-medium text-white transition-all hover:bg-white/10 w-full sm:w-auto">
              View our work
            </button> */}
          </motion.div>
